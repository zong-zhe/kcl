...
pub fn _kclvm_get_fn_ptr_by_name(name: &str) -> u64 {
	match name {
		...
		"kclvm_builtin_str_removeprefix" => crate::kclvm_builtin_str_removeprefix as *const () as u64,
		"kclvm_builtin_str_removesuffix" => crate::kclvm_builtin_str_removesuffix as *const () as u64,
		...
		"kclvm_context_pkgpath_is_imported" => crate::kclvm_context_pkgpath_is_imported as *const () as u64,
		"kclvm_context_set_debug_mode" => crate::kclvm_context_set_debug_mode as *const () as u64,
		"kclvm_context_set_disable_none" => crate::kclvm_context_set_disable_none as *const () as u64,
		"kclvm_context_set_disable_schema_check" => crate::kclvm_context_set_disable_schema_check as *const () as u64,
		"kclvm_context_set_import_names" => crate::kclvm_context_set_import_names as *const () as u64,
		"kclvm_context_set_kcl_filename" => crate::kclvm_context_set_kcl_filename as *const () as u64,
		"kclvm_context_set_kcl_line_col" => crate::kclvm_context_set_kcl_line_col as *const () as u64,
		"kclvm_context_set_kcl_location" => crate::kclvm_context_set_kcl_location as *const () as u64,
		...
		"kclvm_context_set_list_option_mode" => crate::kclvm_context_set_list_option_mode as *const () as u64,
		"kclvm_context_set_strict_range_check" => crate::kclvm_context_set_strict_range_check as *const () as u64,
		"kclvm_convert_collection_value" => crate::kclvm_convert_collection_value as *const () as u64,
		...
		"kclvm_default_collection_insert_int_pointer" => crate::kclvm_default_collection_insert_int_pointer as *const () as u64,
		"kclvm_default_collection_insert_value" => crate::kclvm_default_collection_insert_value as *const () as u64,
		...
		"kclvm_net_is_global_unicast_IP" => crate::kclvm_net_is_global_unicast_IP as *const () as u64,
		"kclvm_net_is_interface_local_multicast_IP" => crate::kclvm_net_is_interface_local_multicast_IP as *const () as u64,
		"kclvm_net_is_link_local_multicast_IP" => crate::kclvm_net_is_link_local_multicast_IP as *const () as u64,
		"kclvm_net_is_link_local_unicast_IP" => crate::kclvm_net_is_link_local_unicast_IP as *const () as u64,
		...
		"kclvm_schema_do_check_with_index_sign_attr" => crate::kclvm_schema_do_check_with_index_sign_attr as *const () as u64,
		...
		"kclvm_value_Function_using_ptr" => crate::kclvm_value_Function_using_ptr as *const () as u64,
		...
		"kclvm_value_check_function_ptr" => crate::kclvm_value_check_function_ptr as *const () as u64,
		...
		"kclvm_value_cmp_greater_than_or_equal" => crate::kclvm_value_cmp_greater_than_or_equal as *const () as u64,
		"kclvm_value_cmp_less_than" => crate::kclvm_value_cmp_less_than as *const () as u64,
		"kclvm_value_cmp_less_than_or_equal" => crate::kclvm_value_cmp_less_than_or_equal as *const () as u64,
		...
		"kclvm_value_schema_with_config" => crate::kclvm_value_schema_with_config as *const () as u64,
		...
		"kclvm_value_to_json_value_with_null" => crate::kclvm_value_to_json_value_with_null as *const () as u64,
