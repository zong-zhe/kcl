...
pub(crate) fn kclvm_get_service_fn_ptr_by_name(name: &str) -> u64 {
    match name {
        ...
        "KclvmService.GetSchemaType1" => get_schema_type_1 as *const () as u64,
...
pub(crate) fn get_schema_type_1(serv: *mut kclvm_service, args: *const c_char) -> *const c_char {
    call!(serv, args, GetSchemaTypeArgs1, get_schema_type_1)
}
